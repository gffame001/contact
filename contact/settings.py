...
SECRET_KEY = 'django-insecure--0%^@gagv)3&vsg&hcmk28^_jol#u#_lq4c#fv)-m=0twrq#lu'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres.fkofiomaebjhodmnfvcl',
        'PASSWORD': 'sLdwLMxvNsdDNnbN',
...
EMAIL_HOST_PASSWORD = 'ujnf tguh saqg qvnt'